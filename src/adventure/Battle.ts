...
export const userAction = (nowPlayer: Player, encounter: Units): void => { // 전투시 유저의 턴
  let graphTurn = true;
...
export const encounterAction = (nowPlayer: Player, encounter: Units, encounterKillCount: number): void => { //전투시 적의 턴 함수
...
export const attackStage = (nowPlayer: Player, encounter: Units, encounterKillCount: number): void => { // 마주침 단계
...
export const recoveryEncounter = (): void => {
  generateNomalEnemy();
}
